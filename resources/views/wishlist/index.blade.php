                ...
                @foreach($wishlist as $proizvod)
                    <div class="product-card">
                        <div class="product-image">
                            @if(!empty($proizvod->image))
                                <img src="{{ asset($proizvod->image) }}" alt="{{ $proizvod->name }}">
                            @else
                                <span>Nema slike</span>
                            @endif
                        </div>
                        <div class="product-info">
                            <div class="product-name">{{ $proizvod->name }}</div>
                            <div class="product-price">{{ $proizvod->price }} RSD</div>
